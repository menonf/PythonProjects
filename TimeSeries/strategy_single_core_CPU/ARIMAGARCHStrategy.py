...
PList = [1, 2, 3, 4, 5]             # Lag order of the symmetric innovation
DList = [1]                         # Difference or Lag order of the asymmetric innovation
QList = [1, 2, 3, 4, 5]             # Lag order of lagged volatility
